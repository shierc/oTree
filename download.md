...
* Download [oTree](https://github.com/oTree-org/oTree/archive/master.zip) and unzip it to a convenient location. (Or, use Git to clone [this repo](https://github.com/oTree-org/otree))
